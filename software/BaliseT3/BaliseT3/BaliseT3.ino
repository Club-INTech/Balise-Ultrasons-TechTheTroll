...
// Delta-T maximum entre deux acquisitions suppos�es voisines
#define MAX_GAP	6250	// �s
...
// Pour envoyer les donn�es finales via la xBee
...
/*
	Indique si le temps stock� � l'indice 'indice' est trop en retard par rapport aux autres temps d�j� enregistr�s
*/
