...
/*
	...
	Coordonn�e X (indices 1-2) : uint16_t
		tramme[1] : octet de poids fort
		tramme[2] : octet de poids faible

	Coordonn�e Y (indices 3-4) : uint16_t
...
public:
	...
	/* 
		Formate et envoi les donn�es (x,y) pr�c�d�es d'un indicateur identifiant la balise source de ces donn�es 
		Unit� : mm	
	*/
